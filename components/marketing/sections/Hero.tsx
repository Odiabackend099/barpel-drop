...
function CardStackDemo() {
  ...
  // Calendly-style: 3 cards stacked with depth
  // Front card centered, middle offset right+up, back offset more right+up
      ...
      {cards.map((card, cardIndex) => {
        ...
        return (
          ...
          >
            ...
            <div className="bg-white/[0.07] backdrop-blur-2xl">
              {/* Gradient top border */}
