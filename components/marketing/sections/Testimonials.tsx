...
const testimonials = [
  ...
  },
  {
    company: 'ShopMax Pro',
    stat: '4.2x',
    description: 'increase in cart recovery rate',
  ...
  },
  {
    company: 'TrendyMart',
    stat: '$50K',
    description: 'saved in support costs annually',
...
export default function Testimonials() {
  ...
  return (
    <section className="section-padding bg-gradient-to-br from-teal-50/30 via-slate-50 to-emerald-50/30 overflow-hidden">
      <div className="container-default">
        <div ref={sectionRef}>
          ...
          <div className="section-header flex flex-col md:flex-row md:items-end md:justify-between gap-4 mb-12 opacity-0 translate-y-6">
            <div>
              <h2 className="heading-section text-brand-navy mb-2">
                Discover how stores grow with{' '}
                <span className="text-brand-teal">Barpel</span>
              </h2>
            </div>
            <Link
          ...
          >
            ...
            <div className="absolute -top-16 right-0 flex gap-2 z-10">
              <button
                onClick={prevSlide}
                className="w-10 h-10 rounded-full border border-light-mint flex items-center justify-center text-brand-navy hover:bg-off-white transition-colors duration-200"
            ...
            <div className="overflow-hidden">
              ...
              >
                {testimonials.map((testimonial) => (
                  ...
                  >
                    <div className="group relative bg-white rounded-2xl overflow-hidden border border-light-mint shadow-teal-sm hover:shadow-teal-md transition-all duration-300">
