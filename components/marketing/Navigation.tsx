...
export default function Navigation() {
  ...
  return (
    <motion.nav
      ...
      className="fixed top-0 left-0 right-0 z-50 bg-white border-b border-slate-200/80 transition-all duration-300"
    >
          ...
          >
            <div className="max-w-6xl mx-auto px-4 py-4">
              ...
              >
                ...
                <Link
                  href="/signup"
                  className="block w-full px-3 py-2 text-center text-sm font-medium text-white bg-brand-600 rounded-lg hover:bg-brand-700 transition-colors duration-150"
                  onClick={() => setIsMobileMenuOpen(false)}
                >
                  Get started
                </Link>
