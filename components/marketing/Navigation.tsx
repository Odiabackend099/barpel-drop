            ...
            <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
              <Link
                ...
                className={`px-4 py-2 text-sm font-medium rounded-lg transition-all duration-200 ${
                  isScrolled
                    ? 'text-white bg-slate-900 hover:bg-slate-800 shadow-lg shadow-slate-900/20'
                    : 'text-brand-navy bg-white hover:bg-white/90 shadow-lg shadow-black/20'
                }`}
              >
                Get started
              </Link>
            ...
            <AnimatePresence mode="wait">
              {isMobileMenuOpen ? (
                ...
                <motion.div
                  ...
                  transition={{ duration: 0.2 }}
                >
                  <Menu className={`w-5 h-5 ${isScrolled ? 'text-slate-900' : 'text-white'}`} />
                </motion.div>
              )}
            </AnimatePresence>
          </motion.button>
